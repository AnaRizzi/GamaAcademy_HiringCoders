...
describe('Star Wars Tests', function () {
    this.beforeAll(() => {
        const response = {
            //copia o resultado que é puxado da api
            //assim não precisa acessar a api em todo teste
        ...
        //simulação de busca na api, toda vez que fizer requisição, pegar esse resultado pronto
        nock('https://swapi.dev/api/people')
        .get('/?search=r2-d2&format=json')
        .reply(200, response)
    })

    //aqui dentro define os testes que irão rodar
